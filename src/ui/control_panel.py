...
approach_configs = {
    "EB":   {"active": True,  "model": "Binomial", "rate": 24, "turn_split": 0.75, "left_far_share": 0.11, "heavy_ratio": 0.10},
    "WB":   {"active": True,  "model": "Binomial", "rate": 22, "turn_split": 0.80, "left_far_share": 0.10, "heavy_ratio": 0.10},
    "A_NB": {"active": True,  "model": "Poisson", "rate": 14,  "turn_split": 0.75, "left_far_share": 0.00, "heavy_ratio": 0.15},
    "A_SB": {"active": True,  "model": "Poisson", "rate": 13,  "turn_split": 0.75, "left_far_share": 0.10, "heavy_ratio": 0.15},
    "B_NB": {"active": True,  "model": "Poisson", "rate": 12,  "turn_split": 0.75, "left_far_share": 0.10, "heavy_ratio": 0.15},
    "B_SB": {"active": True,  "model": "Poisson", "rate": 15,  "turn_split": 0.75, "left_far_share": 0.00, "heavy_ratio": 0.15},
}
